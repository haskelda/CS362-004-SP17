...
int main() {
	...
	printf("This is cardtest2.c: testing amegany cardAdventurer():\n");
...
/****************************************   all tests performed with one call to cardEffect_Smithy  **************************************/
	...
	*/
	...
	cardAdventurer(&G, thisPlayer, unnecessaryArray); //play adventurer
	...
	*/
	...
	if (testFlag == 1)
	{
		printf("\nALL TESTS PASSED for cardtest2.c: cardAdventurer()\n\n");
	}else {
		printf("\nTEST FAILURE for cardtest2.c: cardAdventurer()\n\n");
	}
